...
export const QuoteCartModal = ({ isOpen, onClose }) => {
  const { cart, removeFromCart, updateQuantity, clearCart } = useQuoteCart();
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="p-4 bg-slate-900 text-white flex justify-between items-center">
          <h2 className="text-xl font-bold">
            {showForm ? 'Formulario de Cotización' : `Lista de Cotización (${cart.length} productos)`}
          </h2>
          <button 
            onClick={handleClose} 
        ...
        {/* Cuerpo / Lista de productos o Formulario */}
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500">
                        Ref / Modelo: <span className="font-mono text-blue-600">{item.reference}</span>
                      </p>
                      {item.category && (
